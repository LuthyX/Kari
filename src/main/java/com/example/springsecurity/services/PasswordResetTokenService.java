...
import com.example.springsecurity.repositories.PasswordResetTokenRepository;
...
public class PasswordResetTokenService {
    ...
    public String resetPassword(String password, String tokenReset) {
        ...
        PasswordResetToken passwordResetToken = passwordResetTokenRepository.findByTokenReset(tokenReset).orElseThrow(()-> new IllegalStateException("Token is found Invalid"));
